...
public class ProductCategoryServiceImpl extends ServiceImpl<ProductCategoryMapper, ProductCategoryDO> implements ProductCategoryService {
    ...
    @Override
    @CacheEvict(value = "product_category_list", allEntries = true)
    ...
    @Override
    @Caching(evict = {
        @CacheEvict(value = "product_category", key = "#updateReqVO.id"),
        @CacheEvict(value = "product_category_list", allEntries = true)
    })
    ...
    @Override
    @Caching(evict = {
        @CacheEvict(value = "product_category", key = "#id"),
        @CacheEvict(value = "product_category_list", allEntries = true)
    })
    ...
    @Override
    @Cacheable(value = "product_category", key = "#id", unless = "#result == null")
